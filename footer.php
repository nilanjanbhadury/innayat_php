...
<h3>Innayat</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> Where help comes without delivery charges! Need help with groceries but you can't go out? Someone will bring them to your doorstep with Innayat! </p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">customercare@innayat.com</a></span>
                </div>
            </li>
